...
import Datal4 from './api/Datal4';
import "../node_modules/bootstrap/dist/css/bootstrap.min.css";
import "./index.css"
import Lunchmodel from './Lunchmodel';
            ...
            <div className='content1'>
                ...
                <section className='py-4 py-lg5 container section01'>
                    <div className='row justify-content-center align-item-center'>
                        {Datal4.cardDatal4.map((item, index) => {
                            return (
                ...
                {
                    model === true ? <Lunchmodel img={tempdata[1]} title={tempdata[2]} para1={tempdata[3]} para2={tempdata[4]} hide={() => setModel(false)} /> : ''
                }
