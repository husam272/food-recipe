    ...
    return (
        <>
            <div className='content1'>
                                ...
                                <div className='col-11 col-lg-4 col-md-6 col-lg-3 mx-0 mb-4' key={index}>
                                    <div className="card p-0 overflow-hidden h-100 shadow " >
                                        ...
                                        <div className="card-body">
                                            ...
                                            {/* <button className='btn btn2'>add to favorites</button> */}
                                        </div>
                                    </div>
                                </div>
                            )
                ...
                {
                    model === true ? <Model img={tempdata[1]} title={tempdata[2]} para1={tempdata[3]} para2={tempdata[4]} hide={() => setModel(false)} /> : ''
                }
